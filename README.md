...
<img width="50px;" height="50px;" alt="learn to code CSS3" src="./source/media/icons/icon-css3.svg"><img width="50px;" height="50px;" alt="learn to code C, C#, or C++" src="./source/media/icons/icon-c.svg"><img width="50px;" height="50px;" alt="learn to code with lispy langs, like Clojure and Racket" src="./source/media/icons/icon-clojure.svg">
